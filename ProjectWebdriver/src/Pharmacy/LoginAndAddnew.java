...
public class LoginAndAddnew {
		...
		public void setUp() throws Exception{
			...
			baseUrl  = "https://203.190.173.37:8080/thongtinthuoc/Pages/homepage.zul";
		...
		public void testLogin() throws Exception{
			...
			driver.findElements(By.cssSelector(" div.z-window-embedded:not([style*='display: none']) .z-tabpanel:not([style*='display:none']) .z-listbox-body .z-listcell .z-listcell-cnt.z-overflow-hidden img.z-image")).get(0).click();
